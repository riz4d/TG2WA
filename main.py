...
async def cmd_start(update: Update):
    bot.send_message(
        ...
        text=f"Hey {update.effective_user.full_name} 👋🏻\nPlease send a phone number you want to chat with including international code. Developer @riz4d",
...
async def cmd_help(update: Update):
    bot.send_message(
        chat_id=update.effective_chat.id,
        text="You can send the phone number you want to chat with **including international code** \(eg \+447418326731\)",
        parse_mode=ParseMode.MARKDOWN_V2,
    )
